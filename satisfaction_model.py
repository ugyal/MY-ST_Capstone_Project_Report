...
Airline_satisfaction_data = pd.read_csv("test.csv")

# Attribute to be predicted
predict = "Airline_satisfaction_data"

# Dataset/Column to be Predicted, X is all attributes and y is the features .Label encoder
#fit_transform() method is applied to the list of data in that column
...
#  folds to use for k-fold cross-validation. Cross-validation is a technique for
#  assessing how well a machine learning model can generalize to new, unseen data.random seed to use for reproducibility seq
...
# evaluate each model in turn - store result of k fold
results = []
names = []

#splitting folds using cross_val_score
# holds the machine learning algo we add the accuracy scores for the current model to the list of results
for name, model in models:
 ...
 #create plot 1row 1col 1subplot result = accuracy score
fig = pyplot.figure()
...
#Use the trained model to make predictions on the test data and calculate the accuracy
...
#computes the Confusion matrix create new object of conf-
...
print(best_model.predict_log_proba(x_test)[:10])
print(best_model.predict_proba(x_test)[:10])
print('\n-------------------------------------------')
# # ==============================================================================================================================================================================


# Plots a diagonal dashed line
